...
public abstract class AbstractNetideMainModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractNetideMainModule> implements org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.netide.main.impl.rev151001.NetideMainModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.netide.main.impl.rev151001.AbstractNetideMainModule.class);

    //attributes start

    public static final org.opendaylight.controller.config.api.JmxAttribute corePortJmxAttribute = new org.opendaylight.controller.config.api.JmxAttribute("CorePort");
    private java.lang.Integer corePort;
    ...
    public AbstractNetideMainModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractNetideMainModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractNetideMainModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractNetideMainModule oldModule){
    ...
    public boolean isSame(AbstractNetideMainModule other) {
        if (other == null) {
            throw new IllegalArgumentException("Parameter 'other' is null");
        }
        if (java.util.Objects.deepEquals(corePort, other.corePort) == false) {
            return false;
        }
    ...
    public boolean equals(Object o) {
        ...
        AbstractNetideMainModule that = (AbstractNetideMainModule) o;
