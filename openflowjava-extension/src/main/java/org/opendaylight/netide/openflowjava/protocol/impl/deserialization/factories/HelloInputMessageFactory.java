 ...
 *
 */
public class HelloInputMessageFactory  implements OFDeserializer<HelloInput>, DeserializerRegistryInjector{

    private static final int HELLO_ELEMENT_HEADER_SIZE = 0;
    ...
    @Override
    public HelloInput deserialize(ByteBuf rawMessage) {
