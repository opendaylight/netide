 ...
 *
 */
public class QueueGetConfigReplyMessageFactory implements OFSerializer<GetQueueConfigOutput>, SerializerRegistryInjector {
    ...
    public void serialize(GetQueueConfigOutput message, ByteBuf outBuffer) {
        ...
        for (Queues queue : message.getQueues()){
            ...
            for ( QueueProperty property : queue.getQueueProperty()){
                ...
                case OFPQTMINRATE: serializeRateBody(property.getAugmentation(RateQueueProperty.class), propertyBuff);
                    break;
                case OFPQTMAXRATE: serializeRateBody(property.getAugmentation(RateQueueProperty.class), propertyBuff);
                    break;
                case OFPQTEXPERIMENTER: serializeExperimenterBody(property.getAugmentation(ExperimenterIdQueueProperty.class), propertyBuff);
                    break;
                }
