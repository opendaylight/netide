...
import org.opendaylight.netide.netiplib.TopologyUpdateMessage;
 ...
 *
 */
public class TopologyUpdateMessageTest {
    ...
    public void startUp() throws Exception {
        ...
        message = new TopologyUpdateMessage();
        message.setHeader(header);
        message.setTopology("payload");
    }
    ...
    public void testMessageParsingConcrete() {
        ...
        Assert.assertEquals("payload", netconfMessage.getTopology());
